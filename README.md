...
> [![Deploy](https://www.herokucdn.com/deploy/button.png)](https://dashboard.heroku.com/new?template=https://github.com/hhlong2010/vh_demo)
...
| 变量 | 默认值 | 说明 |
| :--- | :--- | :--- |
| `ID` | `fdabea2d-03a7-4d2f-b337-9a996d4bd293` | VMess 用户主 ID，用于身份验证，为 UUID 格式 |
